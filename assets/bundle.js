...
const Board_1 = __webpack_require__(18);
const constants_1 = __webpack_require__(23);
exports.App = () => (React.createElement(Board_1.Board, { cells: constants_1.InitialBoard }));
function start(dom) {
    ReactDOM.render(React.createElement(exports.App, null), dom);
}
exports.start = start;
...
*/
var aa=__webpack_require__(0),m=__webpack_require__(10),A=__webpack_require__(2),B=__webpack_require__(1),ca=__webpack_require__(11),da=__webpack_require__(12),ea=__webpack_require__(13),ha=__webpack_require__(14),ia=__webpack_require__(17),C=__webpack_require__(3);
...
const styleConst = __webpack_require__(4);
exports.Board = (props) => (React.createElement("div", { style: boardStyle() }, _.range(8).map(rowIdx => (React.createElement(exports.BoardRow, { rowIdx: rowIdx, cells: props.cells.slice(rowIdx * 8, (rowIdx + 1) * 8) })))));
const boardStyle = (scale = 1) => ({
    width: styleConst.boardWidth,
    height: styleConst.boardWidth
});
exports.BoardRow = (props) => (React.createElement("div", { style: boardRowStyle() }, _.range(8).map(colIdx => (React.createElement(Cell_1.Cell, { place: { x: colIdx, y: props.rowIdx }, state: props.cells[colIdx] })))));
...
const React = __webpack_require__(0);
const styleConst = __webpack_require__(4);
exports.Cell = (props) => (React.createElement("div", { style: cellStyle() }, props.state));
